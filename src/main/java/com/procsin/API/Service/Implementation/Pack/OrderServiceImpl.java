...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public OrderLogSuccessModel prepareOrder(User user, OrderResponseModel orderModel) {
...
//        }
//
//        OrderLog packLog = new OrderLog(order,OrderLog.OrderStatus.URUN_PAKETLENIYOR,user);
...
//        return new OrderLogSuccessModel(true,"Başarılı",campaign);
    ...
    @Override
    public GenericResponse updateToSupplement(User user, OrderResponseModel orderModel) {
//        Orders order = orderRepository.findByOrderCode(orderModel.OrderCode);
//        if (order == null) {
...
//        }
//
//        OrderLog suppLog = new OrderLog(order, OrderLog.OrderStatus.TEDARIK_SURECINDE, user);
...
//        return new GenericResponse(true,"Başarılı");
    ...
    @Override
    public GenericResponse updateToPackCancel(User user, String orderCode) {
...
//        }
//
//        OrderLog cancelLog = new OrderLog(order, OrderLog.OrderStatus.URUN_PAKETLENIYOR_IPTAL, user);
...
//        return new GenericResponse(true,"Başarılı");
    ...
    @Override
    public GenericResponse finishOrder(User user, OrderResponseModel orderModel) {
//        if (isPackedBefore(orderModel.OrderCode)) {
//            throw new IllegalStateException("Bu sipariş daha önce tamamlanmış");
//        }
//        else {
...
//                throw new IllegalStateException("Bu sipariş hiç oluşturulmamış");
//            }
//            OrderLog finishLog = new OrderLog(order, OrderLog.OrderStatus.KARGO_HAZIR, user);
